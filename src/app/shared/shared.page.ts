...
@Component({
  ...
  imports: [IonFabList, IonFabButton, IonFab, IonIcon, IonRow, IonHeader, IonToolbar, IonTitle, 
            IonContent, FileListItemComponent, RouterLink, FilePopupComponent, AsyncPipe],
})
