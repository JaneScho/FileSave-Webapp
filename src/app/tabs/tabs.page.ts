...
import { IonFabList, IonTabs, IonTabBar, IonTabButton, IonIcon, IonLabel, IonFab, 
        IonFabButton, IonButton } from '@ionic/angular/standalone';
import { addIcons } from 'ionicons';
import { closeSharp, pushOutline, cameraOutline, listOutline, imagesOutline, image, 
        folder, shareSocial, search, settings, cloudUploadOutline, menuOutline, 
        folderOutline, searchOutline, shareSocialOutline, } from 'ionicons/icons';
...
@Component({
  ...
  imports: [RouterLinkActive, RouterLink, IonFabList, IonTabs, IonTabBar, IonTabButton, 
            IonIcon, IonLabel, IonFab, IonFabButton, IonButton],
})
